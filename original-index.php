				...
				<div class="col-md-12">
						<section class="customer-logos slider">
							<?php
								...
								$marcas_slider = $mysqli->query('SELECT * FROM marcas2 ORDER BY nombre');

								while($marcas_sliderr = $marcas_slider->fetch_assoc()){

									echo '<div class="slide"><a href="resultados-marcas.php?idMarca='.$marcas_sliderr['id'].'" class="primary-btn">'.$marcas_sliderr['nombre'].'</a></div>';
									...
									while($consulta = $consultacamiones->fetch_assoc()){
										...
										<div class="product">
											<div class="product-img">
												<img src="'._GetDomain.'productos/'.$consulta['media'].'.jpg'.'">
											...
											<div class="product-body">
												...
												<h3 class="product-name"><a href="'._GetDomain.'/ficha.php?idProducto='.$consulta['id'].'">'.$consulta['nombre'].'</a></h3>
												'.$precio.'
											</div>
