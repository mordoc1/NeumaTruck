			...
			<div class="container">
				...
				<div class="row">
					...
					<?php for ($i=0; $i < count($productos) ; $i++) { ?>
                        <?php echo card_demooooo($productos[$i]['of'], $productos[$i]["marca"],$productos[$i]["media"], $productos[$i]["aplicacion"], $productos[$i]["stock"], $productos[$i]["id"], $productos[$i]["estado"], $productos[$i]["nombre"], $productos[$i]["codigo"], $productos[$i]['v_oferta'],$productos[$i]['v_publicado']); ?>
                    <?php } ?>
