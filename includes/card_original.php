...
function card_demooooo($of, $marcas,$img, $apli, $stk, $ids, $std, $nombre, $cod, $voferta, $vpublicado,$vlista){
  ...
  $html .= $precio;
  $html .=  $of !=0 ? '<p style="color:red;margin-top:0px;margin-bottom:0px">Precio Lista <del>'.MonedaTruckIVA($vpublicado).'</del></p>' : '<br>' ;
  $html .= '<p>'.$codigo.'</p>';
  $html .= '</div>';
